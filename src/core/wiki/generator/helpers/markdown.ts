...
export async function generateLeafPage(node: ModuleTreeNode, deps: PageGenDeps): Promise<void> {
...
export async function generateParentPage(node: ModuleTreeNode, deps: PageGenDeps): Promise<void> {

...
program
  ...
  .option(
    '--source-path <path>',
    'Source directory to analyze (overrides config source_path, alternative to positional [path])',
  )
  .option(
    '--output-path <path>',
    'Output path for .gitnexus/ knowledge graph (overrides config output_path)',
  )
  .addHelpText(
    'after',

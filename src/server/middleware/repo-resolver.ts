...
export function createRepoResolver(
  ...
  jobManager: { listJobs(): any[]; getJob(id: string): any },
...
export function createRepoLockManager(activeRepoPaths: Set<string>) {
...
export const requestedRepo = (req: Request): string | undefined => {

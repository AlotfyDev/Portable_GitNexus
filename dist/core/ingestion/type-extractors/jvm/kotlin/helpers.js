...
export const findKotlinConstructorCallee = (node, classNames) => {
...
export const extractKotlinElementTypeFromTypeNode = (typeNode, pos = 'last') => {
...
export const findKotlinParamElementType = (iterableName, startNode, pos = 'last') => {

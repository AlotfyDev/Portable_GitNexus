...
export const filterCallableCandidates = (candidates, argCount, callForm) => {
    let kindFiltered;
 ...
 */
export const countCallableCandidates = (candidates, argCount, callForm, threshold = 1) => {
    let count = 0;
...
export const toResolveResult = (definition, tier) => ({

...
import { getDefinitionNodeFromCaptures, getLabelFromCaptures, } from '../../utils/ast-helpers.js';
...
import { clearCaches, findEnclosingFunctionId, cachedFindEnclosingClassInfo, cachedExportCheck, getFieldInfo, getMethodInfo, findEnclosingClassNode, findClassNodeByQualifiedName, } from './helpers/cache.js';
import { extractLaravelRoutes } from './helpers/route-extractor.js';
import { extractORMQueries } from './helpers/orm.js';
import { ROUTE_DECORATOR_NAMES, HTTP_CLIENT_ONLY_METHODS, HTTP_CLIENT_RECEIVERS, EXPRESS_ROUTE_METHODS, } from './constants.js';
...
export const processFileGroup = async (files, language, queryString, result, onFileProcessed) => {
